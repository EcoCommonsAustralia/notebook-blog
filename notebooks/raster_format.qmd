---
title: "Convert Raster and Spatial File Formats"
format:
  html:
    toc: true
---
...
[Converting Rasters from ASCII to GeoTIFF](converting_ascii_to_geotiff_notebook.qmd)\
...
[Converting Rasters from GeoTIFF to ASCII](converting_geotif_to_ascii_notebook.qmd)\
...
[Converting GeoTIFF to Shapefile](converting_geotiff_to_shapefile_notebook.qmd)\
...
[Converting Shapefile to GeoTIFF](converting_shapefile_to_geotiff_notebook.qmd)\
...
[Converting GeoTIFF to NetCDF](converting_geotif_to_NetCDF_notebook.qmd)  
...
[Converting NetCDF to GeoTIFF](converting_NetCDF_to_geotiff_notebook.qmd)  
