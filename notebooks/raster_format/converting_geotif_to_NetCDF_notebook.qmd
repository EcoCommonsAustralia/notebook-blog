...
[**Converting Rasters from GeoTIFF (.tif) to NetCDF (.nc) Format**](https://ecocommonsaustralia.github.io/notebook-blog/notebooks/raster_format/converting_geotif_to_NetCDF_notebook.html)
