...
[**Converting Rasters from NetCDF (.nc) to GeoTIFF (.tif) Format**](https://ecocommonsaustralia.github.io/notebook-blog/notebooks/raster_format/converting_NetCDF_to_geotiff_notebook.html)
