...
Editor details: Dr Dax Kellie, Atlas of Living Australia, CSIRO

Contributor details: Dr Martin Westgate (Atlas of Living Australia) contributed to the original discussion; Dr Ryan Newis and Xiang Zhao (EcoCommons) provided feedback.
...
| Stage | Notebook section | What happens |
|---|---|---|
| Set-up | 1 Setup | Install and import the required Python packages |
| Step 1 | 2 Download data from ALA | Query ALA with `galah-python`, filter to camera-trap datasets, and download a sample of images |
| Step 2 | 3 Run SpeciesNet | Load SpeciesNet and run detection, classification, and geofenced predictions on the images |
| Summary | 4 Summary | Review results, limitations, and next steps |
...
<div align="center"><strong>Our partner</strong></div>
